...
class Product_List_Filter_all extends StatelessWidget {
  late final String? type;
  late final bool type2;
  static const String _title = 'Flutter Code Sample';

  Product_List_Filter_all(this.type, this.type2);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: _title,
      home: MyStatefulWidget(type, type2),
    );
  }
}
...
class MyStatefulWidget extends StatefulWidget {
  ...
  MyStatefulWidget(this.typeProc, this.type2, {Key? key})
      : super(key: key);
                                    ...
                                    onPressed: () {
                                      ...
                                      if (value == 'Samyang Sauce') {
                                        Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                                builder: (context) =>
                                                    Product_List_Filter_all('Sauce', type2)));
                                      }
                                      if (value == 'Other') {
                                        Navigator.push(
                                            context,
                  ...
                  Expanded(
                      child: StreamBuilder(
                          stream: FirebaseFirestore.instance
                              ...
                              .orderBy('Product_Price', descending: type2)
                              .snapshots(),
                          builder:
